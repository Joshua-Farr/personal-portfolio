...
`
  ...
  return (
    ...
    <MobileHeaderWrapper>
      <div style={{zIndex:"12"}}>
    <Hamburger direction="right" label="Show menu" rounded distance="sm" easing="ease-in" color={isOpen ? "white" : "black"} size={40} 
    ...
    <MobileMenu>
        ...
        <>
       <MobileLinks>
          <StyledLink data-scroll href="#about" onClick={()=> toggleBurger()}>About</StyledLink>
          <StyledLink data-scroll  href="#work" onClick={()=> toggleBurger()}>Work</StyledLink>
          <StyledLink href="src/assets/Joshua Farr Resume - Software Engineering.pdf" download="Joshua Farr Resume - Software Engineering" onClick={()=> toggleBurger()}>Resume</StyledLink>
